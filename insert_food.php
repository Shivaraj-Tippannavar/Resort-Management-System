...
echo "Connected Successfully";
    ...
    if(isset($_POST['submit'])){
        ...
        $Lunch = $_POST['Lunch'];
        $Eveningsnack = $_POST['Eveningsnack'];
        $Dinner = $_POST['Dinner'];
        $sql = "INSERT INTO food (Custid, Breakfast, Lunch, Eveningsnack, Dinner, amount) VALUES ('$Custid','$Breakfast','$Lunch','$Eveningsnack','$Dinner','200') ";
